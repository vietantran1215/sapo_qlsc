...
import PaymentHistory from '../../../components/MaintenanceCardAdd/PaymentHistory'

import * as maintenanceCardAddActions from '../../../actions/maintenanceCardAdd'
const PaymentHistoryContainer = (props) => {
    return (
        <PaymentHistory maintenanceCardAddActionCreators={props.maintenanceCardAddActionCreators}
